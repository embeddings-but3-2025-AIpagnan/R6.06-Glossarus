...
class Tableau:
    ...
    def to_markdown(self) -> str:
        ...
        # Contenu
        lignes_md.extend("| " + " | ".join(ligne) + " |" for ligne in self.data)
...
if __name__ == "__main__":
    ...
    tableau.write_to_file(Path("tableau.md"))
